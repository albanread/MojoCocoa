# AIR lowering walkthrough

## Variables

| Name | Value |
|:---|:---|
| product_name | Lowering to AIR |
| product | Lowering to AIR | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | https://github.com/albanread/MojoCocoa |
| source_file | KGEN/lib/Compiler/ObjectCompiler/Target/Air/AirBackend.cpp |
...
| docheader_text | Lowering to AIR — how Mojo kernels reach the Apple GPU | Document cover banner title |
...
| header_text_left | Lowering to AIR | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | CocoaMojo — KGEN/lib/Compiler/ObjectCompiler/Target/Air | Optional text shown below the footer rule |
