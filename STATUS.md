...
| Loop unrolling for AIR (D24) | Shipped, gated | LLVM's unroller at its O3 position for AIR, single-block loops ≤128 instructions, partial threshold 1024, loop metadata stripped: FMA-chain bench at the M4's 3.6 TFLOP/s peak from four chains (was 1,321), SRAM matmul +12%, no bench regressed. 7 Sep 2026. |
