...
|:---|:---|
| product_name | Fluid |
| product | Fluid | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | https://github.com/albanread/MojoCocoa |
| source_file | examples/fluid/main.mojo |
| docheader | on | Set to on to draw the standard document cover banner |
| docheader_text | Fluid — a walkthrough | Document cover banner title |
...
| header_text_left | Fluid | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | CocoaMojo — examples/fluid/main.mojo | Optional text shown below the footer rule |
