...
# kernel on the Apple M4 GPU (through the Metal backend); the CPU only decides
# what it looks like and hands the frame to a CAMetalLayer.
#
...
def main() raises:
    ...
    with autoreleasepool():
        ...
        _ = msg_send[ObjCObject, "NSWindow", "setTitle:"](
            win, nsstring(String("Mojo Mandelbrot — Apple M4")).ptr()
        )
        ...
        while running:
            ...
            # Compute AND colour this frame in one Mojo kernel on the M4 GPU
