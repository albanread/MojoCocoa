...
for f in must_fail.mojo must_fail_argcount.mojo must_fail_fn_raises.mojo must_fail_let_assign.mojo must_fail_kwarg_label.mojo must_fail_kwarg_init.mojo must_fail_kwarg_string.mojo must_fail_property_ro.mojo; do run_mustfail "$f"; done
