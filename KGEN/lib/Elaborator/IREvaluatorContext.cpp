...
//===----------------------------------------------------------------------===//
// COCOA: Cocoa metadata queries, arm64/AAPCS64 (COCOA_DESIGN.md)
//===----------------------------------------------------------------------===//

// The Cocoa metadata database moved to KGEN/lib/CocoaKB so the parser can
// reach it too: declaring an Objective-C class with `class` needs a type
// encoding per method, and those come from the SDK rather than from a
// mapping written by hand (COCOA_CLASS_DESIGN.md).
