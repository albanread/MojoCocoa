...
|:---|:---|
| product_name | Boids |
| product | Boids | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | https://github.com/albanread/MojoCocoa |
| source_file | examples/boids/main.mojo |
...
| docheader_text | Boids — a walkthrough | Document cover banner title |
...
| header_text_left | Boids | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | CocoaMojo — examples/boids | Optional text shown below the footer rule |
